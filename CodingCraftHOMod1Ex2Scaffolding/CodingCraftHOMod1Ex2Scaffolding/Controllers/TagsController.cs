...
namespace CodingCraftHOMod1Ex2Scaffolding.Controllers
{
    public class TagsController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "TagId,TagNome,ProdutoId")] Tag tag)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "TagId,TagNome,ProdutoId")] Tag tag)
        {
            if (ModelState.IsValid)
            {
